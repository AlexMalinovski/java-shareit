...
import ru.practicum.shareit.library.api.item.dto.BookingInfoDto;
...
@Mapper(componentModel = "spring", imports = {ItemRequest.class})
public interface ItemMapper {

    @Mapping(target = "request",
            expression = "java(createItemDto.getRequestId() == null ? null : ItemRequest.builder().id(createItemDto.getRequestId()).build())")
